      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              // frame2fzd (33:74)
              margin: EdgeInsets.fromLTRB(111.5*fem, 0*fem, 127.5*fem, 100*fem),
              width: double.infinity,
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
            ...
            Container(
              // textRMX (33:77)
              margin: EdgeInsets.fromLTRB(53*fem, 0*fem, 69*fem, 64*fem),
              width: double.infinity,
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
            ...
            Container(
              ...
              margin: EdgeInsets.fromLTRB(36.5*fem, 0*fem, 52.5*fem, 71*fem),
              child: TextButton(
                onPressed: () {},
                ...
                child: Container(
                  padding: EdgeInsets.fromLTRB(60.5*fem, 15*fem, 50*fem, 15*fem),
                  width: double.infinity,
                  decoration: BoxDecoration (
